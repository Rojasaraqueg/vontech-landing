...
function sendAutoReply(data) {
  ...
  var messageRow = data.message ? "<p style='margin:4px 0;color:#333;'><strong>Message:</strong> " + data.message + "</p>" : "";
  ...
  var htmlBody = "<div style='font-family:Arial,sans-serif;max-width:600px;margin:0 auto;'>"
    ...
    + "</p>"
    + "<p style='color:#555;line-height:1.7;font-size:15px;'>Here is a summary of what you submitted:</p>"
